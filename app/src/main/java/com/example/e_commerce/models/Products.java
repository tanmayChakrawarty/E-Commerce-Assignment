...
public class Products {
    ...
    public Products(String id, String name, double price, boolean isAvailable, String imageUrl) {
        this.id = id;
        this.name = name;
        this.price = price;
    ...
    public static DiffUtil.ItemCallback<Products> itemCallback = new DiffUtil.ItemCallback<Products>() {
        @Override
